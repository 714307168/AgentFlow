...
func TestMobileLogUploadAndAdminAnalysis(t *testing.T) {
	...
	if !hasSignalCode(desktopAnalysis.Signals, "desktop_catalog_refresh_gaps") {
		t.Fatalf("expected desktop catalog refresh gap signal, got %+v", desktopAnalysis.Signals)
	}
